...
As the change from iBGP to eBGP necessitates implementing private AS numbers, an ASN scheme must be developed and adopted. This architectural descision will be covered in a seperate document. 
